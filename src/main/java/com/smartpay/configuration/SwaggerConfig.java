...
public class SwaggerConfig {
	...
	public static final Contact DEFAULT_CONTACT = new Contact("SmartPay", "http://localhost:8080/v1/",
			"saurav.tit@gmail.com");

	public static final ApiInfo API_DEFAULT = new ApiInfo("SmartPay Api Documentation",
			"API Documentation Of StarBanking", "1.0", "urn:tos", DEFAULT_CONTACT, "SmartPay 1.0",
