...
public class MerchantServiceImplTest extends BaseTest {
	...
	@BeforeAll
	public void init() {
		logger.info("MerchantService Methods Test Start.......");
	}

	@DisplayName("Test UpdateUserProfileToMerchant")
	@Test
	void testUpdateUserProfileToMerchant() {
		logger.info("testUpdateUserProfileToMerchant");
		...
		Merchant result = merchantService.updateUserProfileToMerchant("IR104510", merchant);
	...
	@AfterAll
	public void finish() {
		logger.info("MerchantService Methods Test Finished....");
